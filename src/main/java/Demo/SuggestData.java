...
public class SuggestData extends UDF {
	...
	public String evaluate(String index_name , String index_id, String type_name, String vid, Long sumplay, String cn_name) {
	...
	public static void main(String[] args) {
		...
		System.out.println(analyzer.evaluate("search-caicai","1101eef8ff2d4f226d7968aeec1e1a91","search_type", String.valueOf(22), Long.valueOf(1000),"cn_name"));
	}
}
